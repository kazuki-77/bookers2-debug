class User < ApplicationRecord
  ...
  has_many :reverse_of_relationships, class_name: "Relationship", foreign_key: :followed_id #reverse_of_relationshipsは存在しないテーブルなのでclass_name: "Relationship"でテーブルを指定している
